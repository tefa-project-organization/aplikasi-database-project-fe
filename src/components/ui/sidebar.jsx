  ...
  return (
    <div
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[width] duration-150 ease-out md:flex",
          side === "left"
    ...
    compoundVariants: [
      {
        size: "default",
        className:
          "group-data-[collapsible=icon]:size-10 group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0",
      },
    ],
  }
)
